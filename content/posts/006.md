...
找到 `Download` 这个链接，单击它。  ![Install Fira Code](https://mogeko.github.io/images/006/install_fira-code_1.png)
...
打开解压后得到的文件夹。
打开 `/ttf文件夹`。
会看到以下文件  ![Install Fira Code](https://mogeko.github.io/images/006/install_fira-code_2.png)
`Ctrl+A` 全选 -> 右键 -> 安装。
...
![Use Fira Code](https://mogeko.github.io/images/006/use_fira-code_1.png)
然后在右边的窗口中添加
...
![Use Fira Code](https://mogeko.github.io/images/006/use_fira-code_2.png)
...
打开 Chrome。点击右上角的 `┇` -> 设置  ![Use Fira Code](https://mogeko.github.io/images/006/use_fira-code_3.png)
选择 `自定义字体`  ![Use Fira Code](https://mogeko.github.io/images/006/use_fira-code_4.png)
`宽度固定的字体` -> 在下拉菜单中选择 `Fira Code`
![Use Fira Code](https://mogeko.github.io/images/006/use_fira-code_5.png)
