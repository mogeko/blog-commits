...
接着来到 [Travis CI](https://travis-ci.org/account/repositories)，为 **`Blog`** 仓库打上 ☑，然后点 `setting`。
...
<span style="#00FF00">绿色</span> 代表部署成功&emsp;&emsp;<span style="#FFFF00">黄色</span> 代表正在部署&emsp;&emsp;<span style="#FF0000">红色</span> 代表部署失败
