...
因为配置了 **模糊音** 和 **扩充词库**，`luna_pinyin.custom.yaml` 里面的配置过于复杂，我就不贴出来了，后面会给大家讲解 [**如何配置模糊音**](#模糊拼音) 以及[ **如何配置扩充词库**](#扩充词库) 的。
...
[GitHub 地址](https://github.com/xiaoTaoist/rime-dict)&emsp;&emsp;[下载地址](https://mogeko.github.io/images/031/rime-dict.zip)
