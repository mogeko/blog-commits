...
<del>**需要 Magisk 框架** -> [Magisk 介绍与简易安装教程](https://mogeko.github.io/2018/0011/)<del/>
...
如果不知道你安装的 Office 是哪个版本，可以用以下方法查看。-> [判断你安装的 Office 是哪个版本](https://mogeko.github.io/2018/0016/#%E5%88%A4%E6%96%AD%E4%BD%A0%E5%AE%89%E8%A3%85%E7%9A%84-Office-%E6%98%AF%E5%93%AA%E4%B8%AA%E7%89%88%E6%9C%AC)
...
![install_termux](https://mogeko.github.io/images/0016/install_termux.png)
...
![apt_install_curl](https://mogeko.github.io/images/0016/install_curl_vlmcsd.png)
...
首先要**安装 Magisk 框架** -> [Magisk 介绍与简易安装教程](https://mogeko.github.io/2018/0011/)
然后根据你手机的处理器下载 kms-server 模块安装包。
然后打开 Magisk Manager -> 模块 -> **+** -> 选择刚刚下好的模块包 -> 刷好后重启

![Install](https://mogeko.github.io/images/0016/install_kms-server.png)
...
![查看手机的内网 IP](https://mogeko.github.io/images/0016/get_ip_1.png)
...
[可供使用的 KEY](https://mogeko.github.io/2018/0016/#KEY)

## 激活 Office

同样的，KMS 激活服务只能激活 VOL 版的 Office，不过零售版的 Office 可以通过脚本转换为 VOL 版。
如果不知道自己安装的是什么版本的 Office，可以使用这个方法查看 -> [判断你安装的 Office 是哪个版本](https://mogeko.github.io/2018/0016/#%E5%88%A4%E6%96%AD%E4%BD%A0%E5%AE%89%E8%A3%85%E7%9A%84-Office-%E6%98%AF%E5%93%AA%E4%B8%AA%E7%89%88%E6%9C%AC)
