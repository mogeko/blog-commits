...
找到 `Download` 这个链接，单击它。  ![Install Fira Code](https://mogeko.github.io/images/0007/install_fira-code_1.png)
...
打开解压后得到的文件夹。
打开 `/ttf文件夹`。
会看到以下文件  ![Install Fira Code](https://mogeko.github.io/images/0007/install_fira-code_2.png)
`Ctrl+A` 全选 -> 右键 -> 安装。

### 使用 Chocolate 安装

关于 Chocolate，请参考[这篇文章](https://mogeko.github.io/2017/0003/#使用-Chocolatey-安装)。
使用以下命令安装
...
![Use Fira Code](https://mogeko.github.io/images/0007/use_fira-code_1.png)
然后在右边的窗口中添加
...
![Use Fira Code](https://mogeko.github.io/images/0007/use_fira-code_2.png)
...
打开 Chrome。点击右上角的 `┇` -> 设置  ![Use Fira Code](https://mogeko.github.io/images/0007/use_fira-code_3.png)
选择 `自定义字体`  ![Use Fira Code](https://mogeko.github.io/images/0007/use_fira-code_4.png)
`宽度固定的字体` -> 在下拉菜单中选择 `Fira Code`
![Use Fira Code](https://mogeko.github.io/images/0007/use_fira-code_5.png)
