...
好像废话有点多_(:з)∠)_ ->-> [直接开始的传送门](https://mogeko.github.io/2017/0002/#Start)
...
计划任务程序库 -> 创建任务
![添加任务计划](https://mogeko.github.io/images/0002/RunCMDAdmin_1.png)

在弹出的对话框中填写名称（名称随便取，但**一定要记住**）
**勾选 ✅使用最高权限运行**
![添加任务计划](https://mogeko.github.io/images/0002/RunCMDAdmin_2.png)

操作 -> 新建
![添加任务计划](https://mogeko.github.io/images/0002/RunCMDAdmin_3.png)
...
![添加任务计划](https://mogeko.github.io/images/0002/RunCMDAdmin_4.png)
确认

应该能看见新建好的操作
![添加任务计划](https://mogeko.github.io/images/0002/RunCMDAdmin_5.png)
确认

现在找一下列表中有没有刚刚创建的计划任务
找到后右键 -> 运行 以确认能运行
![添加任务计划](https://mogeko.github.io/images/0002/RunCMDAdmin_6.png)

成功运行 CMD，并且是以管理员身份，而且没有弹出 UAC
![添加任务计划](https://mogeko.github.io/images/0002/RunCMDAdmin_7.png)
...
![正确的打开方式](https://mogeko.github.io/images/0002/Shortcut_1.png)
...
![正确的打开方式](https://mogeko.github.io/images/0002/Shortcut_2.png)

填上你喜欢的名字
![正确的打开方式](https://mogeko.github.io/images/0002/Shortcut_3.png)
完成
...
![开始菜单启动](https://mogeko.github.io/images/0002/MoveStartMenu.png)
确定 或 回车
把刚刚创建好的 快捷方式 丢进去

如果嫌快捷方式太丑，可以换图标。
右键刚刚创建的快捷方式 -> 属性 -> 更改图标
![更改图标](https://mogeko.github.io/images/0002/ReIcon_1.png)
他会提示你 “不包含图标”，点确认。

![更改图标](https://mogeko.github.io/images/0002/ReIcon_2.png)
在路径栏中键入
...
回车 列表里只有一个图标，选中它
![更改图标](https://mogeko.github.io/images/0002/ReIcon_3.png)
确认 -> 确认
