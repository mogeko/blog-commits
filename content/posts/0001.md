...
![Logo](https://mogeko.github.io/images/0001/logo.jpg)
...
![UltraISO](https://mogeko.github.io/images/0001/UltraISO_1.png)

然后 启动 -> 写入硬件映象
![UltraISO](https://mogeko.github.io/images/0001/UltraISO_2.png)

不出意外的话你应该可以看到这个
![UltraISO](https://mogeko.github.io/images/0001/UltraISO_3.png)
...
然后就进入了安装界面
![Install](https://mogeko.github.io/images/0001/install_1.jpg)
选择 中文简体 然后选择 安装 Ubuntu

选择 我现在不想连接 WiFi 网络
![Install](https://mogeko.github.io/images/0001/install_2.jpg)

这个第三方软件选不选无所谓，不影响安装
![Install](https://mogeko.github.io/images/0001/install_3.jpg)
点继续后会运行一会儿
...
我这里选择 其他选项
![Install](https://mogeko.github.io/images/0001/install_4.jpg)

然后开始创建分区
选择 空闲 -> 左下脚的 + 号
![Install](https://mogeko.github.io/images/0001/install_5.jpg)
又搞忘截图了 \_(:з)∠)\_ 图片来自<http://www.jianshu.com/p/2eebd6ad284d>

Ubuntu 分区的方式有很多种，具体可以自己 Google

开始创建第一个分区，我们创建 主分区
![Install](https://mogeko.github.io/images/0001/install_6.png)
...
第二个分区是 Swap分区
![Install](https://mogeko.github.io/images/0001/install_7.png)
...
**重点又来了！！！**
第三个分区是 Boot分区
![Install](https://mogeko.github.io/images/0001/install_8.png)
...
第四个分区是 Home分区
![Install](https://mogeko.github.io/images/0001/install_9.png)
...
![Install](https://mogeko.github.io/images/0001/install_10.jpg)
**如果想让 Ubuntu 引导 Windows，就不用设置引导器的位置，默认就好，直接点 现在安装**
**如果想让 Windows 引导 Ubuntu，“安装启动引导器的设备：”选择 Boot 分区 的盘符，再点 现在安装**

选择 shanghai
![Install](https://mogeko.github.io/images/0001/install_11.jpg)

注册用户  **这里设置的密码是用户密码，不是 Root密码**
![Install](https://mogeko.github.io/images/0001/install_12.jpg)

键盘布局选择 汉语 -> 汉语
![Install](https://mogeko.github.io/images/0001/install_13.jpg)

开始安装，喝杯茶 ε=ε=ε=(~￣▽￣)~
[![Install](https://mogeko.github.io/images/0001/install_14.jpg)
等它跑完，它会提醒你重启
...
![EasyBCD](https://mogeko.github.io/images/0001/EasyBCD_1.png)

进 编辑引导菜单 确认一下
![EasyBCD](https://mogeko.github.io/images/0001/EasyBCD_2.png)

引导器制作完成，重启
![Start up](https://mogeko.github.io/images/0001/start_up.jpg)
